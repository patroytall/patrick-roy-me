...
An absolute is great when there are no exception but even if your absolute scenario only brings the number of exceptions down it is still a win. Once the count is reduced, it will allow you to document them to make it a semi-absolute.
